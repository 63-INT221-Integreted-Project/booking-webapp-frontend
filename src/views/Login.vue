...
<template>
    <div class="flex w-full justify-around space-x-4 md:space-x-8 px-9">
        <div class="flex flex-nowrap -mx-2">
            <div class="w-full md:w-[420px] px-4">
                <div
                    class="mx-auto text-center bg-white rounded-lg relative overflow-hidden py-16 px-10 sm:px-12"
                >
                    <div class="mb-10 md:mb-16 text-center">
                        ...
                        >
                            <div
                                class="text-gray-800 block mb-1 font-medium text-3xl tracking-normal"
                            >
                                เข้าสู่ระบบ
                            </div>
                    ...
                    <img src="/kp2/images/loginazure.png" />
                    </router-link>
                    <a
                        href="javascript:void(0)"
